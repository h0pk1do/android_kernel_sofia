cmd_arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb := mkdir -p arch/arm64/boot/dts/qcom/ ; python ./scripts/gcc-wrapper.py /home/justin/kernel/toolchain/bin/aarch64-linux-android-gcc -E -Wp,-MD,arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.d.pre.tmp -nostdinc -I./scripts/dtc/include-prefixes -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.dts.tmp arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb -b 0 -iarch/arm64/boot/dts/qcom/ -i./scripts/dtc/include-prefixes -Wno-unit_address_vs_reg -Wno-simple_bus_reg -Wno-unit_address_format -Wno-pci_bridge -Wno-pci_device_bus_num -Wno-pci_device_reg  -d arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.trinket-usbc-external-codec-idp.dtb.d

source_arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb := arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dts

deps_arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb := \
...
arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb: $(deps_arch/arm64/boot/dts/qcom/trinket-usbc-external-codec-idp.dtb)
